...
27. Lớp ClientInfoView gọi lớp ReturnProcessingView 
28. Lớp ReturnProcessingView hiển thị cho thu ngân. 
29. Thu ngân nhập số lượng trang phục được trả. 
30. Lớp ReturnProcessingView gọi lớp ReturnedCostume. 
31. Lớp ReturnedCostume thực hiện hàm calculateRentedFee(). 
32. Lớp ReturnedCostume trả về số tiền thuê trang phục cho lớp ReturnProcessingView. 
33. Lớp ReturnProcessingView hiển thị số tiền thuê cho thu ngân. 
34. Thu ngân nhấn vào nút hoàn thành. 
35. Lớp ReturnProcessingView gọi lớp ConfirmView 
