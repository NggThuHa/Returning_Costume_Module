...
- Hệ thống cần tìm kiếm khách hàng bằng nhiều thông tin khác nhau (tên, email, sđt) &rarr; Cần phương thức searchClient() 
...
### 2.3.5. Giao diện cập nhật tình trạng trang phục &rarr; ProcessCostumeView 
...
27. Lớp ClientInfoView gọi lớp ProcessCostumeView 
28. Lớp ProcessCostumeView hiển thị cho thu ngân. 
29. Thu ngân nhập số lượng trang phục được trả. 
30. Lớp ProcessCostumeView gọi lớp ReturnedCostume. 
31. Lớp ReturnedCostume thực hiện hàm calculateRentedFee(). 
32. Lớp ReturnedCostume trả về số tiền thuê trang phục cho lớp ProcessCostumeView. 
33. Lớp ProcessCostumeView hiển thị số tiền thuê cho thu ngân. 
34. Thu ngân nhấn vào nút hoàn thành. 
35. Lớp ProcessCostumeView gọi lớp ConfirmView 
...
54. Lớp ConfirmView gọi lớp RentedReceipt.
55. Lớp RentedReceipt thực hiện hàm updateDepositStatus().
56. Lớp RentedReceipt trả về kết quả cho lớp ConfirmView.
57. Lớp ConfirmView báo trả đồ thành công cho thu ngân. 
58. Thu ngân thông báo quá trình trả đồ thành công cho khách hàng.
...
<image src="pics/LoginFrm.png" width="1000">

- **Giao diện trang chủ của thủ ngân:**

<image src="pics/CashierHomeFrm.png" width="1000">

- **Giao diện tìm kiếm khách hàng:**

<image src="pics/SearchClientFrm.png" width="1000">

- **Giao diện thông tin khách hàng:**

<image src="pics/ClientInfoFrm.png" width="1000">

- **Giao diện xử lý trả đồ:**

<image src="pics/ProcessCostumeFrm.png" width="1000">

- **Giao diện thêm lỗi:**

<image src="pics/AddDamageFrm.png" width="1000">

- **Giao diện xác nhận:**

<image src="pics/ConfirmFrm.png" width="1000">
...
- Thuộc tính ẩn: 
    - u: User 
#### 3.3.2.5. ProcessCostumeFrm 
- ProcessCostumeFrm là giao diện cho phép nhân viên thu ngân điền ghi nhận lỗi trang phục nếu có. 
